...
public:
    ...
    void push(D &&data)
    {
        // counter_node_ptr new_node;
        // new_node.ptr_ = new node(data);
        // new_node.external_count_ = 0;
        
        // can be condensed into one line - "{}" or "= {}"
    ...
    std::shared_ptr<T> pop()
    {
        ...
        for(;;) {
            ...
            else if (ptr->internal_count_.fetch_sub(1) == 1) { delete ptr; }
        }
    }
